...
if __name__ == "__main__":
    ...
    out_tokens, out_text = model.text_completion(
        prompts, max_gen_len=1024, temperature=0
    )
    ...
    # the difference with and without KV cache becomes more visible with large models and large sequence lengths.
    print(f"GPU memory usage: {get_gpu_memory()[0]} MB")
